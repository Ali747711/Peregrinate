...
class GlobeGallery {
    constructor(containerId) {
        ...
        // Load gallery items and initialize
                ...
                try {
                        ...
                        img.onload = () => {
                            if (item.mesh) {
                                ...
                                if (item.glowMesh) {
                                    ...
                                    item.glowMesh.geometry = newGeometry.clone();
                                }
                            }
                        };
                    }
                    ...
                    textureLoader.load(
                        ...
                        (texture) => {
                            ...
                            glowPlane.position.copy(position);
                            glowPlane.lookAt(0, 0, 0);
                            glowPlane.rotateY(Math.PI); // Flip to face outward
                            glowPlane.rotation.z += (Math.random() - 0.5) * 0.2;
        ...
        try {
            ...
            this.galleryItems.forEach(item => {
                if (item.glowMesh) {
                    ...
                    if (item.glowMesh.material.emissive) {
                        item.glowMesh.material.emissive.set(this.darkMode ? 0xDDA15E : 0x2C6E49);
                    }
                }
            });
        } catch (error) {
